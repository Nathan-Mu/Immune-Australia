...
class GoogleCalendarApi
{
    ...
    public function CreateCalendarEvent($calendar_id, $summary, $event_date, $description, $access_token) {
        ...
        $curlPost['reminder'] = array('useDefault' => FALSE,
            'overrides' => array(
                array('method' => 'email', 'minutes' => 12 * 60),
                array('method' => 'popup', 'minutes' => 240),
            ));
        $ch = curl_init();
